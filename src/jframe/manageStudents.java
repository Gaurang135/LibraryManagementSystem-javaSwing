...
public class manageStudents extends javax.swing.JFrame {
    ...
    try {
          Connection con = DBconnection.getConnection();
          String sql = "update student_details set student_name = ?, student_course = ?,branch = ? where student_id = ?";
   ...
   // To delete student details
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 1, 2, 2, new java.awt.Color(0, 0, 0)));
        ...
        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 100, 410, 10));
